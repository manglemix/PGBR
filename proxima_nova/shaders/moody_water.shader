...
shader_type 	spatial;
render_mode 	cull_back,diffuse_burley, blend_mix;
//specular_schlick_ggx


// Wave settings:
uniform float	wave_speed		 = 0.5; // Speed scale for the waves
uniform vec4	wave_a			 = vec4(1.0, 1.0, 0.15, 1.0); 	// xy = Direction, z = Steepness, w = Length
uniform	vec4	wave_b			 = vec4(1.0, 0.6, 0.10, 1.55);	// xy = Direction, z = Steepness, w = Length
